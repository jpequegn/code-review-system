...
class Finding(Base):
    ...
    # AI-Generated Suggestions (Task 4.2 additions)
    # Auto-fix generated by LLM (safe, conservative code patch for high/critical findings)
    auto_fix = Column(Text, nullable=True)

    # Educational explanation of why this finding matters
    explanation = Column(Text, nullable=True)

    # Best practice improvement suggestions (bullet points)
